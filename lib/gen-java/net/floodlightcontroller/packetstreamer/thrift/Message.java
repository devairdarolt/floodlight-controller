...
@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused","deprecation"})
...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable, Comparable<Message> {
  ...
  public int compareTo(Message other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetSessionIDs()).compareTo(other.isSetSessionIDs());
    if (lastComparison != 0) {
